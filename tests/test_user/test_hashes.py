...
from flask_site_framework.user.hashes import PasswordHashDriver, SCryptHashDriver, Password


@patch('flask_site_framework.user.hashes.Password')
class TestBaseHashDriver(TestCase):
    ...
    def test_hash(self, mock_pw_cls):
        with patch('flask_site_framework.user.hashes.PasswordHashDriver.gen_salt') as gs, \
        patch('flask_site_framework.user.hashes.PasswordHashDriver.really_hash_password') as rh:
            dr = PasswordHashDriver()
    ...
    def test_hash__salt(self, mock_pw_cls):
        with patch('flask_site_framework.user.hashes.PasswordHashDriver.really_hash_password') as rh:
            dr = PasswordHashDriver()
