...
from . import user_can, user_load
...
@user_can('login', always_abort=True, skip_after_permission_check=True)
def login():
    form = LoginForm()
...
@user_load(current=True)
@user_can('login', always_abort=True, obj_key='user', skip_totp_setup=True)
...
@user_load()
@user_can('edit_user', 'edit_other_user', 'edit_user_admin', 'edit_other_user_admin', obj_key='user')
...
@user_load()
@user_can('edit_user', 'edit_other_user', 'edit_user_admin', 'edit_other_user_admin', obj_key='user', skip_totp_setup=True)
